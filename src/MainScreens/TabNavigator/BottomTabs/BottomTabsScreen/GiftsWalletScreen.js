...
const useWalletTokens = (publicKey) => {
  ...
  const fetchTokens = useCallback(async () => {
    ...
    try {
      ...
      console.log("[useWalletTokens] Error fetching tokens:", err);
...
const useBonkBalance = (publicKey) => {
  ...
  const fetchBalance = useCallback(async () => {
    ...
    try {
      ...
      console.log("[useBonkBalance] Error occurred:", err);
  ...
  useEffect(() => {
    if (user?.walletAddress) {
      try {
        ...
        console.log('Error converting wallet address to PublicKey:', error);
      ...
      try {
        ...
        console.log('Error converting wallet info address to PublicKey:', error);
      }
    }
  }, [user, walletInfo]);
  ...
  useEffect(() => {
    const fetchBonkPrice = async () => {
      try {
        ...
        console.log('Error fetching BONK price:', error);
      }
    };

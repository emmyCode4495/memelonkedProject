...
//       style={{width:152, height:152, alignSelf:'center'}}
//       />
//       <Text style={styles.bonkText}>Told bonk AI ‘think big’ — now it generates my</Text>
//       <Text style={styles.bonkText1}>delusions too!</Text>
//      </View>
//      <View style={styles.textInputFirstView}>
//       <View style={{flexDirection:'row'}}>
//         <Text style={{fontSize:12, marginBottom:5, marginLeft:20, marginTop:-10}}>Subscribe to our faster AI model on our Pro-Plan</Text>
//       <Text  style={{fontSize:12, marginBottom:5, marginLeft:5, fontWeight:'bold',marginTop:-10,color:colors.main }}>UPGRADE PLAN</Text>
//       </View>
     
//       <Pressable style={styles.textInputFirstView1}
//       onPress={() => navigation.navigate('creatememe')}
//       >
        
//         <Image
//       source={require('../../../../assets/images/doge.png')}
//       style={{width:40, height:40, marginLeft:15, marginTop:10}}
//       />
//         <Text style={{color:'grey',marginLeft:5,marginTop:20}}>Tell me your crazy idea.......</Text>
//       </Pressable>
//      </View>
//     </View>
//   )
